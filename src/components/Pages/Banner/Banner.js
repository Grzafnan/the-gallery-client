...
const Banner = () => {
  ...
  return (
    <>
            ...
            <div class="space-y-10">
              ...
              <div>
                ...
                <h2 class="text-3xl md:text-4xl font-extrabold mb-4">
                  Grow your business <span class="text-blue-600">now</span>!
                </h2>
      ...
      {/* <Swiper autoplay={{ delay: 2000 }} navigation={true} modules={[Navigation]} style={{ height: '700px' }} className="mySwiper">
        <SwiperSlide className="relative">
          <img className="w-full" src={image1} alt="" />
          <h1 className="absolute left-[50%] top-[50%] -translate-x-2/4 -translate-y-1/2 text-4xl text-red-600"> Hello</h1>
        </SwiperSlide>
        <SwiperSlide className="relative">
          <img className="w-full" src={image2} alt="" />
          <p className="absolute left-[50%] top-[50%] -translate-x-2/4 -translate-y-1/2">
            <span className="text-4xl font-bold"> Wedding in Dhaka</span>
            <br />
            <span className="capitalize">Destination Photographer</span>
          </p>
        </SwiperSlide>
        <SwiperSlide className="relative">
          <img className="w-full" src={image3} alt="" />
          <h1 className="absolute left-[50%] top-[50%] -translate-x-2/4 -translate-y-1/2 text-4xl text-red-600"> Hello 3</h1>
        </SwiperSlide>
      </Swiper> */}
